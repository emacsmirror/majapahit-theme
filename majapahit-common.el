...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (type          (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-67")  (if (display-graphic-p) "#3c657e" "color-25") ))
        ...
        (inf           (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-73")  (if (display-graphic-p) "#387280" "color-44") ))
