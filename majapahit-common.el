...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    
        ...
        (bg4           (if (eq variant 'dark)  "#73736c"  "#a5a093" ))
        (key1          (if (eq variant 'dark)  "#c5617a"  "#c24e59" ))
        ...
        (str           (if (eq variant 'dark)  "#9e846c"  "#388b65" ))
        ...
        (suc           (if (eq variant 'dark)  "#b5c37b"  "#80a60b" ))
        (green         (if (eq variant 'dark)  "#88a087"  "#388b65" ))
        (yellow        (if (eq variant 'dark)  "#d99174"  "#c97151" ))
        (cyan          (if (eq variant 'dark)  "#8b8b7f"  "#767d75" ))
