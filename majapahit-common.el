...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    
        ...
        (builtin       (if (eq variant 'dark)  "#9e7a59"  "#866a4f" ))
        ...
        (func          (if (eq variant 'dark)  "#adb78d"  "#43743d" ))
        (str           (if (eq variant 'dark)  "#849f98"  "#6b716a" ))
        (type          (if (eq variant 'dark)  "#4a8a9f"  "#356c7d" ))
        (comp          (if (eq variant 'dark)  "#e47376"  "#db4764" ))
        (var           (if (eq variant 'dark)  "#d37a60"  "#9e6039" ))
        (err           (if (eq variant 'dark)  "#8e6a60"  "#f1847b" ))
        (war           (if (eq variant 'dark)  "#d99481"  "#c07d3c" ))
        (inf           (if (eq variant 'dark)  "#768d82"  "#407d8e" ))
        (suc           (if (eq variant 'dark)  "#b5c37b"  "#608b42" ))
        (green         (if (eq variant 'dark)  "#adb78d"  "#43743d" ))
        ...
        (active1       (if (eq variant 'dark)  "#20201a"  "#efefeb" ))
