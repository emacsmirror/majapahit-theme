...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ...
        ;;                                         DARK      LIGHT
        (t-base          (if (eq variant 'dark)   "#FFD7AF" "#60585E" ))
        (t-base2         (if (eq variant 'dark)   "#5F5F5F" "#ADA190" ))
        (t-base3         (if (eq variant 'dark)   "#D7D7AF" "#5F5F87" ))
        (t-cursor        (if (eq variant 'dark)   "#AF875F" "#806C5B" ))
        (t-bg1           (if (eq variant 'dark)   "#242424" "#FDF9EA" ))
        (t-bg2           (if (eq variant 'dark)   "#333333" "#F7F3E5" ))
        (t-bg3           (if (eq variant 'dark)   "#444444" "#E0DDCE" ))
        (t-bg4           (if (eq variant 'dark)   "#7C7C7C" "#ADA790" ))
        (t-key1          (if (eq variant 'dark)   "#D75F87" "#B34D6C" ))
        (t-key2          (if (eq variant 'dark)   "#D7AF87" "#7D7470" ))
        (t-builtin       (if (eq variant 'dark)   "#AF875F" "#806C5B" ))
        (t-keyword       (if (eq variant 'dark)   "#D75F87" "#C45C7B" ))
        (t-const         (if (eq variant 'dark)   "#D7875F" "#AE6A56" ))
        (t-comment       (if (eq variant 'dark)   "#707070" "#979987" ))
        (t-func          (if (eq variant 'dark)   "#AFAFAF" "#777E62" ))
        (t-str           (if (eq variant 'dark)   "#AFAF87" "#6B6254" ))
        (t-type          (if (eq variant 'dark)   "#87AFAF" "#4d6e66" ))
        (t-comp          (if (eq variant 'dark)   "#D78787" "#db4764" ))
        (t-var           (if (eq variant 'dark)   "#878787" "#759494" ))
        (t-err           (if (eq variant 'dark)   "#FF5F87" "#f1847b" ))
        (t-war           (if (eq variant 'dark)   "#D7875F" "#c07d3c" ))
        (t-inf           (if (eq variant 'dark)   "#5f8787" "#7ca194" ))
        (t-interop       (if (eq variant 'dark)   "#D7AF87" "#807b8b" ))
        (t-suc           (if (eq variant 'dark)   "#AFD787" "#96a374" ))
        (t-green         (if (eq variant 'dark)   "#AFD787" "#777e62" ))
        (t-yellow        (if (eq variant 'dark)   "#D7875F" "#d7875f" ))
        (t-cyan          (if (eq variant 'dark)   "#AF8700" "#6b6254" ))
        (t-violet        (if (eq variant 'dark)   "#878787" "#685672" ))
        (t-red           (if (eq variant 'dark)   "#FF8787" "#d25f7e" ))
        (t-inactive      (if (eq variant 'dark)   "#878787" "#d4ceb8" ))
        (t-m-line-brdr   (if (eq variant 'dark)   "#AFAFAF" "#cae8e8" ))
        (t-org-block-bg  (if (eq variant 'dark)   "#282828" "#d9e6dd" ))
        (t-org-h1-bg     (if (eq variant 'dark)   "#303030" "#f0ecde" ))
        (t-org-h2-bg     (if (eq variant 'dark)   "#333333" "#e0ddce" ))
        (t-org-h3-bg     (if (eq variant 'dark)   "#3c3c3c" "#f2eddc" ))
        (t-org-h4-bg     (if (eq variant 'dark)   "#444444" "#f6f1e1" ))
        (t-highlight     (if (eq variant 'dark)   "#1C1C1C" "#f7f5e9" ))
        (t-green-bg      (if (eq variant 'dark)   "#87875F" "#d5e2cd" ))
        (t-red-bg        (if (eq variant 'dark)   "#5F005F" "#e3c8cc" ))
        (t-mkwd          (if (eq variant 'dark)   "#D7AF87" "#a3604d" ))
        (t-pth1          (if (eq variant 'dark)   "#D7875F" "#7d7f71" ))
        (t-pth2          (if (eq variant 'dark)   "#FFAF87" "#a46c7f" ))
        (t-pth3          (if (eq variant 'dark)   "#D7D7D7" "#2b777b" ))
        (t-pth4          (if (eq variant 'dark)   "#AFD7AF" "#54916d" ))
        (t-pth5          (if (eq variant 'dark)   "#FF875F" "#c75072" ))
        (t-pth6          (if (eq variant 'dark)   "#5F8787" "#547580" ))
        (t-pth7          (if (eq variant 'dark)   "#AF875F" "#927c5e" ))
        (t-pth8          (if (eq variant 'dark)   "#878787" "#478cdb" ))
...
;;;;; auto-complete `(ac-candidate-face ((,class (:background ,bg2 :foreground ,base))))
