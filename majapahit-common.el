...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg2           (if (eq variant 'dark)  (if (display-graphic-p) "#3A2F2C" "color-239")  (if (display-graphic-p) "#faf8ee" "color-255")))
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4a3f3d" "color-240")  (if (display-graphic-p) "#efecdf" "color-253")))
        ...
        (builtin       (if (eq variant 'dark)  (if (display-graphic-p) "#957c65" "#957c65") (if (display-graphic-p) "#8d806c" "color-137")))
        (keyword       (if (eq variant 'dark)  (if (display-graphic-p) "#d4576f" "color-210")  (if (display-graphic-p) "#c45c7b" "color-168")))
        (const         (if (eq variant 'dark)  (if (display-graphic-p) "#a29f98" "color-137")  (if (display-graphic-p) "#ae6a56" "color-172")))
        (comment       (if (eq variant 'dark)  (if (display-graphic-p) "#646b63" "color-144")  (if (display-graphic-p) "#979987" "color-144")))
        (comment-bg    (if (eq variant 'dark)  (if (display-graphic-p) "#2A1F1B" "color-235")  (if (display-graphic-p) "#fffdf3" "color-231")))
        (func          (if (eq variant 'dark)  "#adb78d"  (if (display-graphic-p) "#3b7559" "color-65") ))
        (str           (if (eq variant 'dark)  (if (display-graphic-p) "#849f98" "color-109")  (if (display-graphic-p) "#6b6254" "color-137") ))
        (type          (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-109")  (if (display-graphic-p) "#3c657e" "color-67")))
        (comp          (if (eq variant 'dark)  (if (display-graphic-p) "#e47376" "color-210") (if (display-graphic-p) "#db4764" "color-210")))
        (var           (if (eq variant 'dark)  "#d37a60"  (if (display-graphic-p) "#759494" "color-109") ))
        (err           (if (eq variant 'dark)  "#8e6a60"  "#f1847b" ))
        (war           (if (eq variant 'dark)  "#d99481"  "#c07d3c" ))
        (inf           (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-110")  (if (display-graphic-p) "#87afaf" "color-109") ))
        (interop       (if (eq variant 'dark)  "#82859c"  "#685672" ))
        (suc           (if (eq variant 'dark)  (if (display-graphic-p) "#bdc79e" "color-150")  (if (display-graphic-p) "#5faf87" "color-108") ))
        ...
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#78635D" "color-241") (if (display-graphic-p) "#b0c2c2" "color-109")))
        ...
        (highlight     (if (eq variant 'dark)  "#2a2a24"  (if (display-graphic-p) "#F5F3EB" "color-254") ))
...
;;;;; helm
     ...
     `(helm-match ((,class (:foreground ,green :background ,bg1 :weight bold))))
