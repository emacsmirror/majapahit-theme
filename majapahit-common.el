...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ;;                                      DARK        LIGHT
        (base          (if (eq variant 'dark)  (if (display-graphic-p) "#ededd3" "color-231")  (if (display-graphic-p) "#4d5452" "color-238")))
        (cursor        (if (eq variant 'dark)  "#eddebd"  (if (display-graphic-p) "#8d806c" "color-180") ))
        (bg1           (if (eq variant 'dark)  (if (display-graphic-p) "#241f1b" "color-235")  (if (display-graphic-p) "#fffdf3" "color-231")))
        (bg2           (if (eq variant 'dark)  (if (display-graphic-p) "#3c352f" "color-237")  (if (display-graphic-p) "#faf8ee" "color-255")))
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4d433a" "color-239")  (if (display-graphic-p) "#efecdf" "color-253")))
        (bg4           (if (eq variant 'dark)  (if (display-graphic-p) "#756456" "color-241")  (if (display-graphic-p) "#aca591" "#aca591")))
        (key1          (if (eq variant 'dark)  (if (display-graphic-p) "#d6637a" "color-168")  (if (display-graphic-p) "#b54567" "color-168")))
        (key2          (if (eq variant 'dark)  (if (display-graphic-p) "#d4b292" "color-163")  (if (display-graphic-p) "#797388" "#777282")))
        (builtin       (if (eq variant 'dark)  (if (display-graphic-p) "#9c836b" "color-137") (if (display-graphic-p) "#8d806c" "color-137")))
        (keyword       (if (eq variant 'dark)  (if (display-graphic-p) "#d4576f" "color-204")  (if (display-graphic-p) "#c45c7b" "color-168")))
        (const         (if (eq variant 'dark)  (if (display-graphic-p) "#d99784" "color-172")  (if (display-graphic-p) "#ae6a56" "color-172")))
        (comment       (if (eq variant 'dark)  (if (display-graphic-p) "#6d6055" "color-144")  (if (display-graphic-p) "#979987" "color-144")))
        (comment-bg    (if (eq variant 'dark)  (if (display-graphic-p) "#241f1b" "color-235")  (if (display-graphic-p) "#fffdf3" "color-231")))
        (func          (if (eq variant 'dark)  (if (display-graphic-p) "#939080" "color-187")  (if (display-graphic-p) "#3b7559" "color-65") ))
        (str           (if (eq variant 'dark)  (if (display-graphic-p) "#b18a69" "color-180")  (if (display-graphic-p) "#6b6254" "color-137") ))
        (type          (if (eq variant 'dark)  (if (display-graphic-p) "#7e988b" "color-109")  (if (display-graphic-p) "#356c7e" "color-67")))
        ...
        (inf           (if (eq variant 'dark)  (if (display-graphic-p) "#7e988b" "color-67")  (if (display-graphic-p) "#87afaf" "color-109") ))
        ...
        (green         (if (eq variant 'dark)  "#b9c398"  "#3b7559" ))
        ...
        (active1       (if (eq variant 'dark)  (if (display-graphic-p) "#3c352f" "color-238")  (if (display-graphic-p) "#faf8ee" "color-254") ))
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#5d5147" "color-241") (if (display-graphic-p) "#86a9ad" "color-109")))
        (inactive      (if (eq variant 'dark)  "#756456"  "#a5d6d6" ))
        ...
        (org-h2-bg     (if (eq variant 'dark)  "#6d6055"  "#d3e6e6" ))
        (org-h3-bg     (if (eq variant 'dark)  "#736559"  "#f3f1e6" ))
        (org-h4-bg     (if (eq variant 'dark)  "#857567"  "#f6f1e1" ))
        (highlight     (if (eq variant 'dark)  (if (display-graphic-p) "#1c1815" "color-233")  (if (display-graphic-p) "#F5F3EB" "color-254") ))
        (green-bg      (if (eq variant 'dark)  "#7b894f"  "#d5e2cd" ))
        (red-bg        (if (eq variant 'dark)  "#512e31"  "#e3c8cc" ))
        (mkwd          (if (eq variant 'dark)  (if (display-graphic-p) "#ccb7a3" "color-180")  (if (display-graphic-p) "#7e8083" "color-145") ))
