...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg1           (if (eq variant 'dark)  "#181512"  "#f7f7df" ))
        (bg2           (if (eq variant 'dark)  "#21211c"  "#ededd3" ))
        (bg3           (if (eq variant 'dark)  "#40403a"  "#e8e8d0" ))
        ...
        (comment-bg    (if (eq variant 'dark)  "#181512"  "#f7f7df" ))
        ...
        (active1       (if (eq variant 'dark)  "#20201a"  "#e8e8d0" ))
        ...
        (highlight     (if (eq variant 'dark)  "#2a2a24"  "#e8e8d0" ))
