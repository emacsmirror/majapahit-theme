...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg2           (if (eq variant 'dark)  (if (display-graphic-p) "#3A2F2C" "color-239")  (if (display-graphic-p) "#f0e5c2" "color-223")))
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4a3f3d" "color-240")  (if (display-graphic-p) "#ebdebd" "color-223")))
        ...
        (active1       (if (eq variant 'dark)  (if (display-graphic-p) "#4a3f3d" "color-240")  (if (display-graphic-p) "#ebdebd" "color-251") ))
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#78635D" "color-241") (if (display-graphic-p) "#e4d9ba" "color-254")))
        ...
        (mkwd          (if (eq variant 'dark)  (if (display-graphic-p) "#988d84" "color-180")  "#7e8083" ))
