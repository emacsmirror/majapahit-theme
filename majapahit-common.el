...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg1           (if (eq variant 'dark)  "#181512"  "#f7f7e2" ))
        (bg2           (if (eq variant 'dark)  "#21211c"  "#ededd3" ))
        (bg3           (if (eq variant 'dark)  "#40403a"  "#eaead0" ))
        ...
        (comment-bg    (if (eq variant 'dark)  "#181512"  "#f7f7e2" ))
        ...
        (active1       (if (eq variant 'dark)  "#20201a"  "#eaead0" ))
