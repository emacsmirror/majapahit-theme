...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (func          (if (eq variant 'dark)  (if (display-graphic-p) "#abb588" "color-187")  (if (display-graphic-p) "#3b7559" "color-65") ))
        (str           (if (eq variant 'dark)  (if (display-graphic-p) "#939080" "color-180")  (if (display-graphic-p) "#6b6254" "color-137") ))
        ...
        (interop       (if (eq variant 'dark)  "#817f85"  "#807b8b" ))
        ...
        (violet        (if (eq variant 'dark)  "#817f85"  "#685672" ))
