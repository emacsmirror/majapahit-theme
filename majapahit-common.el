...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (cursor        (if (eq variant 'dark)  "#eddebd"  (if (display-graphic-p) "#806c5b" "color-180") ))
        (bg1           (if (eq variant 'dark)  (if (display-graphic-p) "#241f1b" "color-235")  (if (display-graphic-p) "#fdf9ea" "color-231")))
        (bg2           (if (eq variant 'dark)  (if (display-graphic-p) "#3c352f" "color-237")  (if (display-graphic-p) "#f2edcc" "color-255")))
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4d433a" "color-239")  (if (display-graphic-p) "#e0ddce" "color-253")))
        (bg4           (if (eq variant 'dark)  (if (display-graphic-p) "#756456" "color-241")  (if (display-graphic-p) "#ada790" "#ada790")))
        (key1          (if (eq variant 'dark)  (if (display-graphic-p) "#d6637a" "color-168")  (if (display-graphic-p) "#b34d6c" "color-168")))
        (key2          (if (eq variant 'dark)  (if (display-graphic-p) "#d4b292" "color-163")  (if (display-graphic-p) "#7d7470" "#777282")))
        (builtin       (if (eq variant 'dark)  (if (display-graphic-p) "#9c836b" "color-137") (if (display-graphic-p) "#806c5b" "color-137")))
        ...
        (func          (if (eq variant 'dark)  (if (display-graphic-p) "#939080" "color-187")  (if (display-graphic-p) "#777e62" "color-65") ))
        (str           (if (eq variant 'dark)  (if (display-graphic-p) "#b18a69" "color-180")  (if (display-graphic-p) "#6b6254" "color-137") ))
        (type          (if (eq variant 'dark)  (if (display-graphic-p) "#7e988b" "color-109")  (if (display-graphic-p) "#4d6e66" "color-67")))
        ...
        (inf           (if (eq variant 'dark)  (if (display-graphic-p) "#7e988b" "color-67")  (if (display-graphic-p) "#7ca194" "color-109") ))
        ...
        (org-h1-bg     (if (eq variant 'dark)  "#4a3432"  "#f0ecde" ))
        (org-h2-bg     (if (eq variant 'dark)  "#6d6055"  "#e0ddce" ))
        (org-h3-bg     (if (eq variant 'dark)  "#736559"  "#f2eddc" ))
        (org-h4-bg     (if (eq variant 'dark)  "#857567"  "#f6f1e1" ))
        (highlight     (if (eq variant 'dark)  (if (display-graphic-p) "#1c1815" "color-233")  (if (display-graphic-p) "#fffbec" "color-254") ))
        (green-bg      (if (eq variant 'dark)  "#7b894f"  "#d5e2cd" ))
        (red-bg        (if (eq variant 'dark)  "#512e31"  "#e3c8cc" ))
        (mkwd          (if (eq variant 'dark)  (if (display-graphic-p) "#e78f7c" "color-180")  (if (display-graphic-p) "#6b6360" "color-145") ))
