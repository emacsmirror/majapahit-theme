...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#5d5147" "color-239")  (if (display-graphic-p) "#efecdf" "color-253")))
        ...
        (str           (if (eq variant 'dark)  (if (display-graphic-p) "#9c836b" "color-137")  (if (display-graphic-p) "#6b6254" "color-137") ))
        ...
        (green         (if (eq variant 'dark)  "#abb588"  "#3b7559" ))
        (yellow        (if (eq variant 'dark)  "#cc816b"  "#d7875f" ))
        (cyan          (if (eq variant 'dark)  (if (display-graphic-p) "#939080" "color-180")  (if (display-graphic-p) "#6b6254" "color-180")))
