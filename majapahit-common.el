...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (comment       (if (eq variant 'dark)  (if (display-graphic-p) "#786a5d" "color-144")  (if (display-graphic-p) "#979987" "color-144")))
        ...
        (mkwd          (if (eq variant 'dark)  (if (display-graphic-p) "#e78f7c" "color-180")  (if (display-graphic-p) "#7e8083" "color-145") ))
