...
;;;;; auctex / latex-mode
     ...
     `(company-preview-common                          ((,class (:underline t :foreground ,base1))
                                                        (,t-class (:underline t :foreground ,t-base1))))
     ...
     `(company-tooltip-selection                       ((,class (:foreground ,green :background ,highlight))
                                                        (,t-class (:foreground ,t-green :background ,t-highlight))))
