...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    
        ...
        (comment       (if (eq variant 'dark)  "#999999"  "#b5b5b5" ))
        ...
        (active1       (if (eq variant 'dark)  "#262622"  "#fefef7" ))
...
;;;;; company
     ...
     `(company-tooltip ((,class (:background ,bg2 :foreground ,(if (eq variant 'dark) active1 base)))))
     `(company-tooltip-annotation ((,class (:background ,bg2 :foreground ,inf))))
     `(company-tooltip-common ((,class (:background ,bg2 :foreground ,type))))
