...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    
        ;;                                      DARK        LIGHT
        (base          (if (eq variant 'dark)  "#acb1b1"  "#4d5452" ))
        ...
        (func          (if (eq variant 'dark)  "#4c9161"  "#43743d" ))
        (str           (if (eq variant 'dark)  "#9ca49b"  "#6b716a" ))
        (type          (if (eq variant 'dark)  "#51808f"  "#356c7d" ))
        (comp          (if (eq variant 'dark)  "#e47376"  "#db4764" ))
        (var           (if (eq variant 'dark)  "#e19366"  "#9e6039" ))
        ...
        (pth1          (if (eq variant 'dark)  "#e19366"  "#9a9c91" ))
