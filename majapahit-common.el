...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4a403d" "color-242")  (if (display-graphic-p) "#ebdebd" "color-223")))
        ...
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#63615a" "color-243") (if (display-graphic-p) "#e4d9ba" "color-180")))
