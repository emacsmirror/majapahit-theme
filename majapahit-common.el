...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ...
        (bg1           (if (eq variant 'dark)   "#1c1c1c" "#FDF9EA" ))
        (bg2           (if (eq variant 'dark)   "#262626" "#F7F3E5" ))
        (bg3           (if (eq variant 'dark)   "#333333" "#E0DDCE" ))
        ...
        (const         (if (eq variant 'dark)   "#D49A8A" "#777E62" ))
        ...
        (highlight     (if (eq variant 'dark)   "#121212" "#EDE8DB" ))
        ...
        (t-bg1           (if (eq variant 'dark)   "#1C1C1C"  "Linen"  ))
        (t-bg2           (if (eq variant 'dark)   "#262626" "#FFFFD7" ))
        (t-bg3           (if (eq variant 'dark)   "#333333" "#D7D7D7" ))
        ...
        (t-highlight     (if (eq variant 'dark)   "#121212" "#EEEEEE" ))
