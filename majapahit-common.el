...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (key2          (if (eq variant 'dark)  "#bb4e62"  "#777282" ))
        (builtin       (if (eq variant 'dark)  "#9e7a59"  "#696570" ))
        ...
        (interop       (if (eq variant 'dark)  "#82859c"  "#8d806c" ))
        (suc           (if (eq variant 'dark)  "#bdc79e"  "#608b42" ))
        (green         (if (eq variant 'dark)  "#adb78d"  "#3b7559" ))
        (yellow        (if (eq variant 'dark)  "#d37a60"  "#b1573c" ))
        (cyan          (if (eq variant 'dark)  "#8b8b7f"  "#766b5a" ))
        (violet        (if (eq variant 'dark)  "#635363"  "#696570" ))
