...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    
        ;;                                      DARK        LIGHT
        (base          (if (eq variant 'dark)  "#b9b9b3"  "#4d5452" ))
        (cursor        (if (eq variant 'dark)  "#292922"  "#63635d" ))
        (bg1           (if (eq variant 'dark)  "#2c2c25"  "#f3f3e9" ))
        ...
        (key2          (if (eq variant 'dark)  "#c85246"  "#c0403d" ))
        (builtin       (if (eq variant 'dark)  "#88a087"  "#866a4f" ))
        (keyword       (if (eq variant 'dark)  "#d25f76"  "#b84259" ))
        (const         (if (eq variant 'dark)  "#c4beaa"  "#81714d" ))
        (comment       (if (eq variant 'dark)  "#73736d"  "#7c847b" ))
        (comment-bg    (if (eq variant 'dark)  "#2c2c25"  "#f3f3e9" ))
        (func          (if (eq variant 'dark)  "#d99174"  "#43743d" ))
        (str           (if (eq variant 'dark)  "#9e846c"  "#6b716a" ))
        (type          (if (eq variant 'dark)  "#51808f"  "#356c7d" ))
        (comp          (if (eq variant 'dark)  "#e47376"  "#db4764" ))
        (var           (if (eq variant 'dark)  "#b1b59c"  "#9e6039" ))
        ...
        (green         (if (eq variant 'dark)  "#88a087"  "#43743d" ))
        (yellow        (if (eq variant 'dark)  "#d99174"  "#b1573c" ))
        (cyan          (if (eq variant 'dark)  "#8b8b7f"  "#6b716a" ))
        (violet        (if (eq variant 'dark)  "#c5617a"  "#c5617a" ))
        (red           (if (eq variant 'dark)  "#c5617a"  "#d25f76" ))
        (active1       (if (eq variant 'dark)  "#262622"  "#efefeb" ))
        ...
        (green-bg      (if (eq variant 'dark)  "#29422d"  "#d5e2cd" ))
        (red-bg        (if (eq variant 'dark)  "#512e31"  "#e3c8cc" ))
        (mkwd          (if (eq variant 'dark)  "#898b89"  "#7e8083" ))
        (pth1          (if (eq variant 'dark)  "#b1b59c"  "#9a9c91" ))
        (pth2          (if (eq variant 'dark)  "#f1bc6a"  "#d57c59" ))
        (pth3          (if (eq variant 'dark)  "#4da0c4"  "#2c7e78" ))
        (pth4          (if (eq variant 'dark)  "#9aba4f"  "#68ad84" ))
