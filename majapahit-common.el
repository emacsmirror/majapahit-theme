...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg2           (if (eq variant 'dark)  (if (display-graphic-p) "#444444" "color-239")  (if (display-graphic-p) "#f0e5c2" "color-223")))
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4a403d" "color-240")  (if (display-graphic-p) "#ebdebd" "color-223")))
        ...
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#63615a" "color-241") (if (display-graphic-p) "#e4d9ba" "color-254")))
