...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    
        ...
        (builtin       (if (eq variant 'dark)  "#9e7a59"  "#6d533c" ))
        (keyword       (if (eq variant 'dark)  "#d4576f"  "#a72d47" ))
        ...
        (func          (if (eq variant 'dark)  "#adb78d"  "#2f6347" ))
        (str           (if (eq variant 'dark)  "#849f98"  "#585e57" ))
        (type          (if (eq variant 'dark)  "#768d82"  "#2a596b" ))
        (comp          (if (eq variant 'dark)  "#e47376"  "#db4764" ))
        (var           (if (eq variant 'dark)  "#d37a60"  "#974937" ))
        ...
        (green         (if (eq variant 'dark)  "#adb78d"  "#2f6347" ))
        (yellow        (if (eq variant 'dark)  "#d37a60"  "#b1573c" ))
        (cyan          (if (eq variant 'dark)  "#8b8b7f"  "#585e57" ))
