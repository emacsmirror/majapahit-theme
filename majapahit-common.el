...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg2           (if (eq variant 'dark)  (if (display-graphic-p) "#444444" "color-241")  (if (display-graphic-p) "#f0e5c2" "color-223")))
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4a403d" "color-242")  (if (display-graphic-p) "#ebdebd" "color-222")))
        (bg4           (if (eq variant 'dark)  (if (display-graphic-p) "#5c5857" "color-244")  (if (display-graphic-p) "#a7a991" "#a7a991")))
        (key1          (if (eq variant 'dark)  (if (display-graphic-p) "#db6b7e" "color-132")  (if (display-graphic-p) "#bf4550" "color-162")))
        ...
        (comment-bg    (if (eq variant 'dark)  (if (display-graphic-p) "#272727" "color-235")  (if (display-graphic-p) "#f7f4de" "color-230")))
        (func          (if (eq variant 'dark)  "#adb78d"  "#3b7559" ))
        (str           (if (eq variant 'dark)  (if (display-graphic-p) "#849f98" "color-109")  "#6b6254" ))
        (type          (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-67")  (if (display-graphic-p) "#3c657e" "color-31") ))
        ...
        (inf           (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-73")  (if (display-graphic-p) "#387280" "color-152") ))
        ...
        (active1       (if (eq variant 'dark)  (if (display-graphic-p) "#42403d" "color-240")  (if (display-graphic-p) "#ebdebd" "color-222") ))
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#63615a" "color-246") (if (display-graphic-p) "#e4d9ba" "color-180")))
