...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ...
        (bg1           (if (eq variant 'dark)   "#1c1c1c" "#FFFCF1" ))
        (bg2           (if (eq variant 'dark)   "#262626" "#EDEADF" ))
        (bg3           (if (eq variant 'dark)   "#333333" "#DEDBD1" ))
        ...
        (highlight     (if (eq variant 'dark)   "#121212" "#DBD9CF" ))
        ...
        (t-bg1           (if (eq variant 'dark)   "#1C1C1C" "#FFFFFF" ))
