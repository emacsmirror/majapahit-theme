...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ...
        (func          (if (eq variant 'dark)   "#AFAFAF" "#777E62" ))
        ...
        (blue-bg       (if (eq variant 'dark)   "#5FAFAF" "#5FAFAF" ))
...
;;;;; basic stuffs
     ...
     `(isearch                                         ((,class (:bold t :foreground ,base :background ,blue-bg))
                                                        (,t-class (:bold t :foreground ,t-base :background ,t-blue-bg))))
...
;;;;; ivy
     `(ivy-confirm-face                          ((,class (:foreground ,green))
                                                  (,t-class (:foreground ,t-green))))
     `(ivy-current-match                         ((,class (:foreground ,base :background ,blue-bg))
                                                  (,t-class (:foreground ,base :background ,t-blue-bg))))
