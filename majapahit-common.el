...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;                    
        ...
        (cursor        (if (eq variant 'dark)  "#aaaa9d"  "#63635d" ))
        (bg1           (if (eq variant 'dark)  "#2c2c25"  "#fafaf6" ))
        (bg2           (if (eq variant 'dark)  "#33332c"  "#f3f3ed" ))
        (bg3           (if (eq variant 'dark)  "#40403a"  "#e3e3da" ))
        (bg4           (if (eq variant 'dark)  "#4f4f49"  "#c6c3bd" ))
        (key1          (if (eq variant 'dark)  "#c5617a"  "#c5617a" ))
        (key2          (if (eq variant 'dark)  "#cf7b86"  "#cf7b86" ))
        (builtin       (if (eq variant 'dark)  "#88a087"  "#a78d6a" ))
        (keyword       (if (eq variant 'dark)  "#db687f"  "#db687f" ))
        (const         (if (eq variant 'dark)  "#c4beaa"  "#949488" ))
        (comment       (if (eq variant 'dark)  "#999999"  "#cccccc" ))
        (comment-bg    (if (eq variant 'dark)  "#2c2c25"  "#fafaf6" ))
        (func          (if (eq variant 'dark)  "#d99174"  "#d88a6a" ))
        (str           (if (eq variant 'dark)  "#51808f"  "#45b0d3" ))
        (type          (if (eq variant 'dark)  "#4b97a8"  "#4b97a8" ))
        (comp          (if (eq variant 'dark)  "#e47376"  "#db4764" ))
        (var           (if (eq variant 'dark)  "#ae9d84"  "#ae9d84" ))
        (err           (if (eq variant 'dark)  "#8e6a60"  "#f1847b" ))
        (war           (if (eq variant 'dark)  "#d99481"  "#d69e8b" ))
        (inf           (if (eq variant 'dark)  "#45b0d3"  "#51808f" ))
        (suc           (if (eq variant 'dark)  "#b5c37b"  "#abbe71" ))
        (green         (if (eq variant 'dark)  "#88a087"  "#84a082" ))
        (yellow        (if (eq variant 'dark)  "#d99174"  "#d88a6a" ))
        (cyan          (if (eq variant 'dark)  "#949488"  "#aaaa9d" ))
        (violet        (if (eq variant 'dark)  "#c5617a"  "#db687f" ))
        (red           (if (eq variant 'dark)  "#c5617a"  "#db687f" ))
        (active1       (if (eq variant 'dark)  "#262622"  "#f3f3ed" ))
        (active2       (if (eq variant 'dark)  "#45b0d3"  "#e7e7da" ))
        (inactive      (if (eq variant 'dark)  "#45b0d3"  "#7eacac" ))
        (m-line-brdr   (if (eq variant 'dark)  "#45b0d3"  "#e3e3da" ))
        ...
        (highlight     (if (eq variant 'dark)  "#333c45"  "#e7e7da" ))
