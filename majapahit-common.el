...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (bg3           (if (eq variant 'dark)  (if (display-graphic-p) "#4e4e4e" "color-239")  (if (display-graphic-p) "#efecdf" "color-253")))
        (bg4           (if (eq variant 'dark)  (if (display-graphic-p) "#73736a" "color-242")  (if (display-graphic-p) "#aca591" "#aca591")))
        (key1          (if (eq variant 'dark)  (if (display-graphic-p) "#db6b7e" "color-168")  (if (display-graphic-p) "#b54567" "color-168")))
        (key2          (if (eq variant 'dark)  (if (display-graphic-p) "#c4627c" "color-163")  (if (display-graphic-p) "#797388" "#777282")))
        (builtin       (if (eq variant 'dark)  (if (display-graphic-p) "#957c65" "color-137") (if (display-graphic-p) "#8d806c" "color-137")))
        ...
        (comment-bg    (if (eq variant 'dark)  (if (display-graphic-p) "#272727" "color-235")  (if (display-graphic-p) "#fffdf3" "color-231")))
        (func          (if (eq variant 'dark)  (if (display-graphic-p) "#adb78d" "color-187")  (if (display-graphic-p) "#3b7559" "color-65") ))
        (str           (if (eq variant 'dark)  (if (display-graphic-p) "#957c65" "color-137")  (if (display-graphic-p) "#6b6254" "color-137") ))
        (type          (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-109")  (if (display-graphic-p) "#356c7e" "color-67")))
        (comp          (if (eq variant 'dark)  (if (display-graphic-p) "#e47376" "color-210") (if (display-graphic-p) "#db4764" "color-210")))
        (var           (if (eq variant 'dark)  (if (display-graphic-p) "#849f98" "color-109")  (if (display-graphic-p) "#759494" "color-109") ))
        ...
        (active1       (if (eq variant 'dark)  (if (display-graphic-p) "#333333" "color-238")  (if (display-graphic-p) "#faf8ee" "color-254") ))
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#768d82" "color-67") (if (display-graphic-p) "#86a9ad" "color-109")))
        (inactive      (if (eq variant 'dark)  "#45b0d3"  "#a5d6d6" ))
        (m-line-brdr   (if (eq variant 'dark)  (if (display-graphic-p) "#667a71" "color-144")  (if (display-graphic-p) "#cae8e8" "color-152") ))
        ...
        (highlight     (if (eq variant 'dark)  (if (display-graphic-p) "#222222" "color-234")  (if (display-graphic-p) "#F5F3EB" "color-254") ))
