...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 257))) ;;
        ...
        (t-bg1           (if (eq variant 'dark)   "#242424"  "Linen"  ))
...
;;;;; extra font-locks
     `(clojure-keyword-face                            ((,class (:foreground ,green :underline t :weight bold))
                                                        (,t-class (:foreground ,t-green :underline t :weight bold))))
