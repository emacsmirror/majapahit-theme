...
(defun create-majapahit-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (suc           (if (eq variant 'dark)  "#bdc79e"  "#5faf87" ))
        ...
        (active1       (if (eq variant 'dark)  (if (display-graphic-p) "#4a3f3d" "color-240")  (if (display-graphic-p) "#ece8d0" "color-251") ))
        (active2       (if (eq variant 'dark)  (if (display-graphic-p) "#78635D" "color-241") (if (display-graphic-p) "#d5caa9" "color-254")))
        (inactive      (if (eq variant 'dark)  "#45b0d3"  "#7eacac" ))
        (m-line-brdr   (if (eq variant 'dark)  "#4c4c42"  "#ece8d0" ))
        (org-block-bg  (if (eq variant 'dark)  "#282523"  "#d9e6dd" ))
        (org-h1-bg     (if (eq variant 'dark)  "#4a3432"  "#f1eadd" ))
        (org-h2-bg     (if (eq variant 'dark)  "#63635a"  "#e0e4e3" ))
        (org-h3-bg     (if (eq variant 'dark)  "#73705a"  "#f7f3e2" ))
